...
class Admin(models.Model):
    ...
    pengerja_id = models.CharField(primary_key=True, max_length=255)
    password = models.CharField(max_length=255)
    user_session_key = models.CharField(unique=True, max_length=255, blank=True, null=True)
...
class CoolYouthUser(models.Model):
    pengerja_id = models.AutoField(primary_key=True)
    nomor_telepon = models.CharField(unique=True, max_length=255)
